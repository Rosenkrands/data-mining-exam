...
\begin{frame}{\secname}{\subsecname}
  \begin{figure}
    \includegraphics[width=.75\textwidth]{scripts/output/scree_plot.pdf}
    \caption{Scree plot showing the number of clusters against the total within-cluster sum of squares.}
  \end{figure}
\end{frame}
